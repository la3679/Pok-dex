...
- Deferred to their dedicated roadmap phases: Team Builder, Compare, Type Chart, map controls, battle redesign, and analytics charts. Their routes remain visible as clearly labelled placeholders rather than pretending that features exist.
